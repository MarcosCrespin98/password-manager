...
export function RepeatedPasswordsChart(props: RepeatedPasswordsChartProps) {
    ...
    const totalPasswordsWithPages = unique + repeated * 2;
    ...
    return (
        <Card className="flex flex-col">
            <CardHeader className="items-center pb-0">
                <CardTitle>Analitica de contraseñas</CardTitle>
                <CardDescription>Repetidas vs Unicas</CardDescription>
            </CardHeader>
            <CardContent className="flex flex-1 items-center pb-0">
                <ChartContainer
                config={chartConfig}
                className="mx-auto aspect-square w-full max-w-[212px]"
                >
                <RadialBarChart
                    data={chartData}
                    endAngle={180}
            ...
            <CardFooter className="flex-col gap-2 text-sm">
                <div className="flex items-center gap-2 font-medium leading-none">
                    Contraseñas guardadas {totalPasswordsWithPages} 
                </div>
            </CardFooter>
        </Card>
    )
